 ...
 */
export function placeDebugSpheres(points: Vector3[], parent: Object3D, size: number = 0.5) {
    const material = new THREE.MeshLambertMaterial();
    points.forEach((point) => {
        const sphere = new THREE.SphereGeometry(size).translate(point.x, point.y, point.z);
 ...
 */
export function efficientPlaceDebugSpheres(
    points: Vector3[],
    parent: Object3D,
): THREE.InstancedMesh {
