...
Crochet patterns may be entered\index{pattern!entry} in two ways - using the @PTI or the @ASB.
...
In the case that the resultant text in the @PTI is invalid\index{pattern!invalid}, the @CRW will not update, and will continue to display the same @RM corresponding to the last valid pattern text.
...
\section{Interacting with the \atcmd{RM}}\label{sec:interactrm}
...
Changing the \term{thickness} of a stitch:
\begin{enumerate}
...
Changing the \term{hook size} of a stitch:
\begin{enumerate}
...
Changing the \term{laxity} of a stitch:
\begin{enumerate}
